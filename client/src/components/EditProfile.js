...
const EditProfile = props => {
  ...
  useEffect(() => {
    setFormData({
      ...
      twitter: !appState.profile.social ? "" : appState.profile.social.twitter,
      facebook: !appState.profile.social ? "" : appState.profile.social.facebook,
      linkedin: !appState.profile.social ? "" : appState.profile.social.linkedin,
      youtube: !appState.profile.social ? "" : appState.profile.social.youtube,
      instagram: !appState.profile.social ? "" : appState.profile.social.instagram
    });
  }, []);
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      appDispatch({ type: "flashMessage", value: "Congrats, You have successfully updated your profile!" });
    } catch (e) {
      console.log(e);
    }
  }
  ...
  return (
    <Fragment>
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <div className="my-2">
          <button onClick={() => setSocialInputs(!socialInputs)} type="button" className="btn btn-info">
